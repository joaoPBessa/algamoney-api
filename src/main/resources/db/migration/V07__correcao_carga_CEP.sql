...
ALTER TABLE CATEGORIA ALTER COLUMN CODIGO SET DEFAULT NULL;

DROP SEQUENCE CATEGORIA_CODIGO;
...
ALTER TABLE PESSOA ALTER COLUMN CODIGO SET DEFAULT NULL;

DROP SEQUENCE PESSOA_CODIGO;
...
ALTER TABLE LANCAMENTO ALTER COLUMN CODIGO SET DEFAULT NULL;

DROP SEQUENCE LANCAMENTO_CODIGO;
